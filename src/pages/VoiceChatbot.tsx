...
const VoiceChatbot = () => {
  ...
  const generateResponse = (userText: string): string => {
    ...
    const responses = {
      ...
      ta: {
        greeting:
          "வணக்கம்! நான் ஆரோக்யமித்ரா, உங்கள் AI ஆரோக்ய உதவியாளர். உங்கள் ஆரோக்ய பிரச்சனைகளில் உதவ முடியும், மருத்துவர்களுடன் இணைக்க முடியும், அல்லது மருத்துவ ஆலோசனை வழங்க முடியும். இன்று நான் உங்களுக்கு எ��்படி உதவ முடியும்?",
        fever:
