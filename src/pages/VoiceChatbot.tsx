  ...
  const generateResponse = (userText: string): string => {
    ...
    const responses = {
      ...
      hi: {
        ...
        headache:
          "सिर दर्द के लिए यह करें:\n\n• शांत, अंधेरे कमरे में आराम करें\n• सिर/गर्दन पर ठंडी या गर्म पट्टी लगाएं\n• खूब पानी पिएं\n• जरू���त हो तो पैरासिटामोल 500mg लें\n�� स्क्रीन से दूर रहें\n• गर्दन की हल्की स्ट्रेचिंग करें\n\nअगर सिर दर्द तेज़, अचानक, ���ा बुखार/दिखने में समस्या के साथ है तो तुरंत इलाज लें। डॉक्टर से जोड़ दूं?",
        stomach:
      ...
      ta: {
        greeting:
          "வணக்கம்! நான் ஆரோக்யமித்ரா, உங்கள் AI ஆரோக்ய உதவியாளர். உங்கள் ஆரோக்ய பிரச்சனைகளில் உதவ முடியும், மருத்துவர்களுடன் இண��க்க முடியும், அல்லது மருத்துவ ஆலோசனை வழங்க முடியும். இன்று நான் உங்களுக்கு எப்படி உதவ முடியும்?",
        fever:
          "உங்களுக்கு காய்ச்சல் இருப்பது புரிகிறது. இதை செய்யுங்கள்:\n\n• ஓய்வெடுத்து நிறை�� தண்ணீர் குடியுங்கள்\n• காய்ச்சல் 100°F க்கு மேல் இருந்தால் 6 மணி நேரத்திற்கு ஒருமு��ை ��ா��ா��ி��்ட���ால் (500mg) எடுங்கள்\n• நெற்றியில் குளிர்ந்த துணி வையுங்கள்\n• வெப்பநிலையை தொடர்ந்து சரிபார்க்கவும்\n• காய்ச்சல் 3 நாட்களுக்கு மேல் நீடித்தால் அல்லது 103°F க்கு மேல் சென்றா��் உடனே மருத்துவரை பாருங்கள்\n\nமருத்துவ ஆலோசனைக்காக உங்களை இணைக்கட்டுமா?",
        headache:
