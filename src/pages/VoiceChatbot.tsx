...
const VoiceChatbot = () => {
  ...
  useEffect(() => {
    ...
    if (!isSupported) {
      ...
      setMicrophoneError(
        "Voice recognition is not supported in this browser. Please use Google Chrome for voice features.",
      );
      addAssistantMessage(
    ...
    if (
      ...
      setTimeout(() => {
        ...
        const messages = {
          ...
          hi: "क्या मैं अभी आपके ��िए 108 आपातकालीन नंबर डायल करूं?",
  ...
  const generateResponse = (userText: string): string => {
    ...
    const responses = {
      ...
      hi: {
        greeting:
          "नमस्ते! मैं आरोग्यमित्र हूं, आपका AI स्वास्थ्य सहायक। मैं आपकी स्वास्थ्य समस्याओं में मदद कर सकता हूं, डॉक्टरों से जोड़ सकता हूं, या चिकित��सा सलाह दे सकता हूं। आज मैं आपकी कैसे सेवा कर सकता हूं?",
        fever:
