...
const VoiceChatbot = () => {
  ...
  const generateResponse = (userText: string): string => {
    ...
    const responses = {
      ...
      hi: {
        greeting:
          "नमस्ते! मैं आरोग्यमि���्र हूं, आपका AI स्वास्थ्य सहायक। मैं आपकी स्वास्थ्य समस्याओं में मदद कर सकता हूं, डॉक्टरों से जोड़ सकता हूं, या चिकित्सा सलाह दे सकता हूं। आज मैं आपकी कैसे सेवा कर सकता हूं?",
        fever:
          "मैं समझ गया कि आपको बुखार है। यह करें:\n\n• आराम करें और ���ूब पानी पिएं\n• अगर बुखार 100°F से ज्यादा है तो हर 6 घंटे में पैरासिटामोल (500mg) लें\n• माथे पर ठंडी पट्टी रखें\n• नियमित तापमान चेक करें\n• अगर बुखार 3 दिन से ज्यादा रहे या 103°F से ज्��ादा हो तो तुरंत डॉक्टर से मिलें\n\nक्या मैं आपको डॉक्टर से सलाह के लिए जोड़ दूं?",
        headache:
      ...
      bn: {
        greeting:
          "হ্যালো! আমি আরোগ্যমিত্র, আপনার AI স্বাস্থ্য সহায়ক। আমি আপনার স্বাস্থ্য সমস্যায় সাহায্য করতে পারি, ডাক্তারদের সাথে যোগাযোগ করাতে পারি বা চিকিৎসা ��রামর্শ দিতে পারি। আজ আমি কীভাবে আপন���কে সাহায্য করতে পারি?",
        fever:
