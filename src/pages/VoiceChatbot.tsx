...
const VoiceChatbot = () => {
    ...
    if (
      ...
      setTimeout(() => {
        ...
        const messages = {
          ...
          ta: "நான் இப்போது உங்களுக்காக 108 அவசர எண்ணை டயல் செய்யட்ட���மா?",
  ...
  const makeEmergencyCall = () => {
    ...
    const confirmMessages = {
      ...
      hi: "क्या आप आपातकालीन से���ाओं (108) को कॉल करना चाहते हैं?",
