    ...
    if (
      ...
      setTimeout(() => {
        ...
        const messages = {
          ...
          te: "న���ను ఇప్పుడే మీ కోసం 108 అత్యవసర నంబర్ డ���ల్ చేయాలా?",
        };
