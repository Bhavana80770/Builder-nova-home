...
const VoiceChatbot = () => {
  ...
  const generateResponse = (userText: string): string => {
    ...
    const responses = {
      ...
      te: {
        greeting:
          "హలో! నేను ఆరోగ్యమిత్రను, మీ AI ఆరోగ్య సహాయకుడను. నేను మీ ఆరోగ్య సమస్యలలో సహాయం చేయగలను, వైద్యులతో కలుపుతాను లేదా వైద్య సలహా ఇవ్వగల��ు. ఈరోజు నేను మీకు ఎలా సహాయం చేయగలను?",
        fever:
