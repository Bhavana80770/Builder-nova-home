    ...
    if (
      ...
      setTimeout(() => {
        ...
        const messages = {
          ...
          bn: "আমি কি এখনই আপনার জন্য 108 জরুরি নম্বর ���ায়াল করব?",
