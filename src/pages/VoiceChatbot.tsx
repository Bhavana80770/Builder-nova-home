  ...
  const generateResponse = (userText: string): string => {
    ...
    const responses = {
      ...
      bn: {
        ...
        default:
          "আমি আপনার স্বাস্থ্য সমস্যা বুঝতে পারছি। ভাল সাহায্যের জন্য বলুন:\n\n• আপনার প্রধান লক্ষণ কী?\n• এটি কখন শুরু হয়েছে?\n• কতটা গুরুতর (1-10)?\n• অন্য কোন সংশ্লিষ্ট সমস্যা?\n\nআমি তাৎক্ষণিক যত্নের পরামর্শ দিতে পারি এবং প্রয়োজনে ডাক্���ারদের সাথে যোগাযোগ করিয়ে দিতে পারি। আমি কীভাবে আপনাকে সাহায্য করতে পারি?",
      },
      ta: {
        greeting:
