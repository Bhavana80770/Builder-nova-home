...
const VoiceChatbot = () => {
  ...
  const generateResponse = (userText: string): string => {
    ...
    const responses = {
      ...
      bn: {
        greeting:
          "হ্যালো! আমি আরোগ্যমিত্র, আপনার AI স্বাস্থ্য সহায়ক। আমি আপনার স্বাস্থ্য সমস্যায় সাহায্য করতে পারি, ডাক্তারদের সাথে যোগাযোগ করাতে পারি বা চিকিৎসা ��রামর্শ দিতে পারি। আজ আমি কীভা���ে আপনাকে সাহায্য করতে পারি?",
        fever:
