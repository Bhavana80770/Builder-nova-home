...
const VoiceChatbot = () => {
  ...
  const generateResponse = (userText: string): string => {
    ...
    const responses = {
      ...
      hi: {
        greeting:
          "नमस्ते! मैं आरोग्यमित्र हूं, आपका AI स्वास्थ्य सहायक। मैं आपकी स्वास्थ्य समस्याओं में मदद कर सकता हूं, डॉक्टरों से जोड़ सकता हूं, या चिकित्सा सलाह दे सकता हूं। आज मैं ��पकी कैसे सेवा कर सकता हूं?",
        fever:
  ...
  const makeEmergencyCall = () => {
    ...
    const confirmMessages = {
      ...
      hi: "क्या आप आपातकालीन सेवाओं (108) को कॉल करना चा��ते हैं?",
