...
const Login = () => {
  ...
  const handleGoogleLogin = (e: React.MouseEvent) => {
    ...
    console.log("Google Demo Login");

    // Simple demo login - no external redirect
    setTimeout(async () => {
      try {
  ...
  const handleFacebookLogin = (e: React.MouseEvent) => {
    ...
    console.log("Facebook Demo Login");
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                {isGoogleLoading ? (
                  <>
                    <div className="w-5 h-5 mr-2 border-2 border-indigo/30 border-t-indigo rounded-full animate-spin"></div>
                    Signing in...
                  </>
                ) : (
                  <>
